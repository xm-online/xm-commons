package com.icthh.xm.commons.domain.event.outbox.config;

import com.icthh.xm.commons.domain.event.config.event.InitSourceEvent;
import com.icthh.xm.commons.domain.event.outbox.service.impl.OutboxTransport;
