...
public class CodeSnippetExecutor {
    ...
    public Object runCodeSnippet(@UseAsLepContext BaseLepContext lepContext, String ...snippetKeys) {
        return null;
    }

    @LogicExtensionPoint(value = SNIPPET, resolver = SnippetListLepKeyResolver.class)
    public Object runCodeSnippet(@UseAsLepContext BaseLepContext lepContext, List<String> snippetKeys) {
        return null;
    }
}
