...
public class SecurityMaskingConsoleAppender extends ConsoleAppender<ILoggingEvent> {
     ...
     * Example:
     * <pre>{@code
     * keywords="pin=,puk:,password"
     * }</pre>
     *
     * @param keywords comma-separated keywords list; each entry is trimmed
     */
     ...
     *
     * @param replacementMessage replacement text (can be {@code null} if masking is disabled)
     */
